...
describe('RefreshAuthenticationUseCase', () => {
  ...
  it('should throw error if refresh token not string', async () => {
    ...
    // Action & Assert
    await expect(refreshAuthenticationUseCase.execute(useCasePayload)).rejects.toThrowError('REFRESH_AUTHENTICATION_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPE_SPESIFICATION');
  });
