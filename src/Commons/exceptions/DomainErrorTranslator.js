...
DomainErrorTranslator._directories = {
  ...
  'ADD_THREAD_COMMENT_REPLY.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat thread comment reply baru karena properti yang dibutuhkan tidak ada'),
  'ADD_THREAD_COMMENT_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membuat thread comment reply baru karena tipe data tidak sesuai'),
};
